<?php
  ...
  ***********************************************************/
  	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
  		//Delete users temp image
  			$temppath = 'assets/images/profile_pictures/'.$profile_id.'_temp.jpeg';
  ...
  ***********************************************************/
  	...
  	//Set Upload directory
  		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/tipical_sns_clone/assets/images/profile_pictures';
  	//Set File name
  ...
  if (isset($_POST['x'])){
  	...
  	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){
  		...
  		//save the new cropped version
  			imagejpeg($dst_r, "assets/images/profile_pictures/".$finalname."n.jpeg", 90);
  		...
  		$result_path ="assets/images/profile_pictures/".$finalname."n.jpeg";
